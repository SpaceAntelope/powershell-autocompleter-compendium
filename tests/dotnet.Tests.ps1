...
"@ -split "`r?`n"
        ...
        Context "Parse dotnet list --help" {
            it "return options with help text" {
                ...
                $actual = ExctractParseables $dotnet_list | ? Kind -eq Options | ForEach-Object { ParseOption $_ }
            ...
            it "return commands with help text" {
                ...
                $actual = ExctractParseables $dotnet_list | ? Kind -eq Commands | ForEach-Object { ParseCommand $_ }
